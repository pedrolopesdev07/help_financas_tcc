...
export default function App() {
  ...
  const renderPage = () => {
    switch (activePage) {
      case "dashboard":
        return <Dashboard userData={userData} transactions={transactions} onNewTransaction={handleNewTransaction} onNavigate={setActivePage} theme={theme} onToggleTheme={handleToggleTheme} />;
      case "transactions":
